...
This case ATTESTS the live artifact tests/adversarial/self_drive/last_verdict.json. When that
...
@L.case_main
def run():
    L.attest("tests/adversarial/self_drive/last_verdict.json", expect="PASS")
