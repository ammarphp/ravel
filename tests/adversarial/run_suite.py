#!/usr/bin/env python3
"""tests/adversarial/run_suite.py -- the per-gate verification board (L6).
...
This engine (modeled on scripts/verify_fixes.py) discovers those case scripts, runs each as a
...
Usage:
  ...
  run_suite.py --with-self-drive  # actually run the self-drive gate(s) (needs clean_room --live)
