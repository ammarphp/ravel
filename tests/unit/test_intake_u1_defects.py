...
MODULE_FILES = {
    'pyhf_exclude': 'src/ravel/physics/pyhf_exclude.py',
    'resource_census': 'src/ravel/workflow/resource_census.py',
    'route_prompt': 'src/ravel/workflow/route_prompt.py',
    'result_pack': 'src/ravel/workflow/result_pack.py',
    'validate_task_contract': 'src/ravel/validation/validate_task_contract.py',
    'validate_run_state': 'src/ravel/validation/validate_run_state.py',
    'validate_checkin': 'src/ravel/validation/validate_checkin.py',
}
...
def _mod(name):
    spec = importlib.util.spec_from_file_location(name, REPO / MODULE_FILES[name])
...
def test_route_prompt_selftest_still_green():
    r = subprocess.run([sys.executable, str(REPO / "src/ravel/workflow/route_prompt.py"), "--selftest"],
...
def test_contract_write_initializes_run_state(tmp_path):
    ...
    r = subprocess.run([sys.executable, str(REPO / "src/ravel/workflow/route_prompt.py"),
