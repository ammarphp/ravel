# tests/unit/test_spine_sim_caselib.py
"""tests/adversarial/_case_lib.py -- the shared spine_sim case toolkit (Task 6.2).
...
CASELIB = REPO / "tests" / "adversarial" / "_case_lib.py"
