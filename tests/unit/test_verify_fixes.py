...
VERIFY_FIXES_PY = REPO / "scripts" / "verify_fixes.py"
REAL_REGISTRY = REPO / "docs" / "development" / "change-registry.md"
...
def test_real_command_executes_via_subprocess_from_repo_root(tmp_path):
    ...
    result = mod.run_verify(
        "CR-034", "python3 scripts/run.py ravel.validation.validate_task_contract --selftest")
