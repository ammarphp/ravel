# tests/unit/test_clean_room.py
"""tests/adversarial/clean_room.py -- the un-hinted self-drive launcher verdict engine (Task 6.6).
...
CR = REPO / "tests" / "adversarial" / "clean_room.py"
...
def test_surveying_the_repo_before_checkin1_is_a_violation():
    ...
    p = _payload(
        ...
        files_written=[],
        final_text="Let me first survey DIRECTORY.md and docs/development/status.md ...")
    v = mod.evaluate_transcript(p)
