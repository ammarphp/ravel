...
not describe their relationship. [The complete content comparison](../../../evidence/audits/2026-09-05-local-public-gap.json)
...
two provenance checks. The retained [full replay result](../../../evidence/audits/2026-09-05-benchmark-replay.json)
...
1. **Strict contracts at live entry points.** Exact schema version, nested structures, finite
   ...
   [schema reference](../../reference/task-contract.md) records every accepted
