...
| 4 | reproduce arXiv:2408.00049 dijet+photon Fig. 5 + wide-width variants | `reproduce` | **`blocked-shape-fit`** | the NAMED refusal + generator-level offer (`docs/research/reviews/generality.md`) |
