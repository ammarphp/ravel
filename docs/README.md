...
- [Developer guide](development/README.md): architecture, repository layout, and release work.
- [Explanatory guides](guides/README.md): preserved background reading with current-command pointers.
- [Research](research/README.md): related work, historical evaluations, and prospective experiments.
