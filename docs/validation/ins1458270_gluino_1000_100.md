...
- Model: gluino-pair (m_gl=1000, m_LSP=100), g~ -> q qbar chi10, NLO+NLL (k=1.915); masses (parent, LSP): (1000.0, 100.0) GeV.
...
Observed ratio: 0.945623; deviation |1 − ratio|: 5.4%.
Observed/expected S95 from the replay: 5.10637 / 8.83734.
...
Certification verdict: WARN; regression tier: Acceptable.
Recorded residual: 13.24%.
