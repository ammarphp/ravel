...
|---|---|---|---|
| R0 | Toolchain sanity | the locked benchmark baselines | `python3 scripts/run.py ravel.validation.benchmark --fast`, `python3 scripts/audit.py` (read-only by default; `--write` to refresh `docs/development/audit.md`) |
