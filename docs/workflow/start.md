...
(`docs/workflow/checklists/check-ins.md`).
...
6. **Verification panel** — before you see any result, an adversarial panel (`docs/workflow/steps/09-verify.md`)
...
1. Fire the **`physicist-intake` skill** (`.claude/skills/physicist-intake/SKILL.md` if your
   ...
   **CHECK-IN 1 composed per `docs/workflow/checklists/check-ins.md`** · the **compute block**.
2. The procedure behind the check-ins is `docs/workflow/README.md` steps 2→9 (in THIS directory):
