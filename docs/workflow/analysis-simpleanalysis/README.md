...
> (`docs/workflow/reference/native-pipeline.md`; `docs/workflow/steps/04-analyze.md` Option B) — no podman, no VM, no x86
...
likelihood. (When it ships a Rivet routine instead, use Option A in `docs/workflow/steps/04-analyze.md`.) The
two options are co-equal; pick by what the analysis provides (`docs/workflow/checklists/choosing-routine.md`).
...
`docs/workflow/steps/07-exclude.md` (pyhf). Worked example: `docs/workflow/reference/example-simpleanalysis-path.md`.
