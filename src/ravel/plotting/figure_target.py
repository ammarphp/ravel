...
Resolution precedence for the figure id (docs: docs/workflow/checklists/figure-contract.md):
...
AXES ARE FACTS, NOT DEFAULTS (docs/workflow/checklists/plot-guidelines.md): the published figure's axis
...
def cmd_resolve(args):
    ...
    try:
        ...
        from . import figure_manifest as _fm
