...
The spectrum leg of the replane track (docs/workflow/reference/projection-replane.md §Replane): per
...
try:
    ...
    raise ImportError("spectrum_mix requires NumPy; install ravel-hep[replay].") from exc
