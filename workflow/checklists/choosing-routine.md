...
- **SimpleAnalysis** — the SR-yield framework many ATLAS/CMS SUSY searches publish a routine for; its
  ...
  for EwkCompressed2018/slepton** (`../steps/04-analyze.md` Option B); else the container fallback
  (podman+mapyde, `../analysis-simpleanalysis/`). Steps 4B, 5 (yield/kinematics plots), 7.
...
`../analysis-simpleanalysis/config-decisions.md`.
