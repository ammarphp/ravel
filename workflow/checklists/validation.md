...
0. **Detector fidelity** (`checklists/detector-fidelity.md`, step 3.5). The object-level half: a
...
`framework/validation/<id>.json` sibling) — it does not duplicate the per-row rationale.
