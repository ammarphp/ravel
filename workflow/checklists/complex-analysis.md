...
- **Run single-weight**: `rivet --skip-weights`, one YODA, never reentrant-merge (`steps/04-analyze.md`).
...
match its patterns — `reference/example-rivet-ewk-path.md` is the worked shape to follow.
