...
"""SINGLE-POINT quick-look: locate ONE tested model point on a published SUSY mass-plane contour.
  ...
  >>> SCOPE NOTE (read workflow/steps/08-scan.md). This is the UNIT-LEVEL / SANITY view: it takes ONE
...
AXIS SCALING (workflow/checklists/plot-guidelines.md): the PUBLISHED figure's axis scales are FACTS,
...
See workflow/steps/05-visualize.md, workflow/checklists/plot-guidelines.md, and .claude/rules/plots.md.
"""
import argparse
import os
import sys
...
def main():
    ...
    # ---- axis scaling. The decisive rule (workflow/checklists/plot-guidelines.md): the PUBLISHED
    ...
    # ---- resolve effective per-axis log state (workflow/checklists/plot-guidelines.md: the
