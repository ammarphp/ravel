...
PRODUCT-CONTRACT.md Sec 7 / CR-031).
...
these defects (F1..F4 in framework/capability-matrix.json) with nothing to catch it; this is that
...
workflow/checklists/summary-plot.md):
