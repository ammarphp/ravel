...
#   bash trial-runs/_infrastructure/restframes_native_build.sh
#
...
RECAST="$REPO/stages/01-event-generation/build/tools/miniforge3/envs/recast"
TARBALL="$REPO/stages/01-event-generation/build/tools/simple-analysis-src/Ext_RestFrames/data/tarball"
INSTALL="$REPO/stages/01-event-generation/build/tools/restframes-native"
