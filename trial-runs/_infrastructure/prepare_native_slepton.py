...
MSHARE = f"{REPO}/stages/01-event-generation/build/tools/miniforge3/envs/pipeline/share/mapyde"
INFRA = f"{REPO}/trial-runs/_infrastructure"
...
GEN_TEMPLATE = f"{INFRA}/templates/slepton_isrslep_generate.mg5"
...
def write_shower_cfg(rundir, out):
    ...
    open(out, "w").write(
        ...
        "! per workflow/reference/shower-config-template.cfg\n"
        "Beams:frameType = 4\n"
        f"Beams:LHEF = {lhe}\n"
        "Print:quiet = on\n"
    )
