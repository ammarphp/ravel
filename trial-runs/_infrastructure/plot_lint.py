#!/usr/bin/env python
"""plot_lint -- the MACHINE GATE behind workflow/checklists/plot-criteria.md (CR-016).
...
mass_plane_overlay.py. This CLI exists for two things:
  ...
  plot_lint.py --selftest     build a deliberately colliding figure (expect violations) and a
                              ...
                              $CONDA run -n rivet python trial-runs/_infrastructure/plot_lint.py --selftest
