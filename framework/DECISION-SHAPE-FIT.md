...
census, `framework/interrogations/generality.md`). Before this decision, every such ask got the
NAMED refusal + a generator-level offer (`PRODUCT-CONTRACT.md` §6.1) — two live precedents
...
residual work — see `PRODUCT-CONTRACT.md` §6.1. Three costed options (below) were the basis for
the decision:
