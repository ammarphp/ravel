...
> experiments). One block per bold-titled bullet in `framework/KNOWN-LIMITATIONS.md`, walked in file
...
- `investigated-to: thorough` (2026-06-09→2026-07-06) — `framework/validation/` (4 per-analysis
  certs), `framework/benchmark/BENCHMARK.md` (8-case locked baseline, 2.4–13.2% with dated re-lock
  history), residual decomposed by measurement in `framework/interrogations/shower-decay.md` (tune
...
- `investigated-to: thorough` (2026-06-09) — `framework/interrogations/statistics.md` (k-trap
...
- `investigated-to: brief` (2026-06-09) — `framework/interrogations/generation.md` GEN-D2/D3 +
...
- `investigated-to: thorough` (2026-06-09/10) — `framework/interrogations/shower-decay.md` SD-D1
  ...
  PASS@7.4%); `framework/STATUS.md` records the per-experiment-emulation-for-NEW-runs decision.
...
- `investigated-to: brief` (2026-06-09) — `framework/interrogations/shower-decay.md` SD-D3: the
...
- `investigated-to: thorough` (2026-07-06) — CR-001 (measured hyper-excluded pathology, fix +
  ...
  ×2.14 σ_tag split at m=200, 500-evt A/B) in `framework/CHANGES-REGISTRY.md` +
...
- `investigated-to: thorough` (2026-06-16, record backfilled 2026-07-06) — the port itself is
  ...
  `workflow/reference/native-pipeline.md` §SCOPE (RJR `--objects` interface already general;
...
- `investigated-to: thorough` — the entry itself is the dated saga (build chain, shim, 8.2-vs-8.3
  ...
  explicitly decoupled (SModelS working + MA5 built; `framework/crosscheck/SUMMARY.md`, AUDIT R7
...
- `investigated-to: thorough` (2026-06-16→2026-07-06) — the ~9 h/point sequential cost and its
  replacement are measured and recorded (`workflow/reference/native-pipeline.md`: native 30–50
